...
% *SAME AS BEFORE*
ECG = load('patient1.mat');
d = ECG.val/1000; % convert mili Volt to Volt
fs = 360; % constant sampling frequency
unit = 'Volts';
x = (250:+1:250+fs);
t = (1:+1:length(d))./fs;
figure(1);
...
% In this example the notch frequency is 60 Hz.
fn = 60; % notch frequency
bw = 120; % bandwidth
